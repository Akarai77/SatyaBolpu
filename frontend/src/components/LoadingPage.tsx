...
const LoadingPage = () => {
  ...
  return (
    <div className={`w-screen h-screen grid place-items-center fixed bottom-0 overflow-hidden z-[9997] bg-black`}>
